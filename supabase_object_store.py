...
SUPABASE_URL = "https://gjubidwteihgqeiulmcr.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "sb_publishable_WYZbcAxNme1_8gyU_ZvunQ_kKciGmlY" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = r"C:\Users\mohit\Downloads\CC-Lab1\CC-Lab1\PES1UG23CS367.png" # Replace with the local image path
image_name = "PES1UG23CS367.png"  # Desired name for the uploaded file
